/**
 * Bulk Delete Comments Use Case
 *
 * Elimina múltiples comentarios en una sola operación
...
export class BulkDeleteCommentsUseCase {
  ...
  async execute(commentIds: string[]): Promise<void> {
    ...
    await this.commentRepository.bulkDelete(ids);
  }
}

<template>
  <NuxtLayout name="profile">
    <div>
      ...
      <!-- Header -->
      <div class="mb-8">
        <h1 class="text-2xl font-semibold text-gray-900 mb-2">Mi perfil</h1>
        ...
        <form @submit.prevent="handleUpdateProfile">
          <div class="space-y-6">
            ...
            <div class="flex items-center space-x-6">
              ...
              <div>
                <h3 class="text-lg font-medium text-gray-900">{{ user?.getName() || 'Usuario' }}</h3>
                <p class="text-sm text-gray-500">{{ user?.getRole().value() || 'Rol' }}</p>
              </div>
            </div>

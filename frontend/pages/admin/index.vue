      ...
      <div class="mb-8">
        <div class="flex items-center space-x-3 mb-4">
          ...
          <div>
            ...
            <p class="text-gray-600">Gestiona el contenido y usuarios de la plataforma</p>
          </div>
        </div>
      </div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <div class="bg-white rounded-lg shadow p-6">
          <div class="flex items-center">
            ...
            <div class="ml-4">
              <p class="text-sm font-medium text-gray-600">Suscriptores Newsletter</p>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
        ...
        <div class="bg-white rounded-lg shadow p-6 hover:shadow-lg transition-shadow">
          <div class="flex items-center space-x-3 mb-4">
            ...
            <h3 class="text-lg font-semibold text-gray-900">Gestión de Contenido</h3>
          </div>
          <p class="text-gray-600 mb-4">Crea y edita posts, páginas estáticas</p>
          <NuxtLink
            to="/admin/posts"
            class="inline-flex items-center text-blue-600 hover:text-blue-500 font-medium"
          >
        ...
        <div class="bg-white rounded-lg shadow p-6 hover:shadow-lg transition-shadow">
          <div class="flex items-center space-x-3 mb-4">
            ...
            <h3 class="text-lg font-semibold text-gray-900">Moderación</h3>
          </div>
          <p class="text-gray-600 mb-4">Revisa y modera comentarios</p>
          <NuxtLink
            to="/admin/comments"
            class="inline-flex items-center text-blue-600 hover:text-blue-500 font-medium"
          >
        ...
        <div v-if="isSuperAdmin" class="bg-white rounded-lg shadow p-6 hover:shadow-lg transition-shadow">
          ...
          <p class="text-gray-600 mb-4">Configuración avanzada y mantenimiento</p>
          <NuxtLink
            to="/admin/settings"
            class="inline-flex items-center text-blue-600 hover:text-blue-500 font-medium"
          >

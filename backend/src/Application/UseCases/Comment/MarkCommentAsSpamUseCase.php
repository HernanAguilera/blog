...
final readonly class MarkCommentAsSpamUseCase
{
    ...
    public function execute(string $commentId): void
    {
        ...
        // Dispatch event
        $this->eventDispatcher->dispatch(new CommentMarkedAsSpam($comment));
    }
}

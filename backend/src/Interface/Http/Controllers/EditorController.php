...
use Blog\Interface\Http\Requests\AutoSavePostRequest;
use Blog\Interface\Http\Requests\PreviewPostRequest;
use Blog\Interface\Http\Resources\AutoSaveResponse;
use Blog\Interface\Http\Resources\PreviewResponse;
use Blog\Interface\Http\Resources\DraftResource;
...
class EditorController
{
    ...
    public function showPreview(string $token): Response
    {
        try {
            ...
            $htmlSanitizer = app(\Blog\Domain\Post\Services\HtmlSanitizerInterface::class);
